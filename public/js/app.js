...
var _UserDirectory = require('./components/UserDirectory.vue');

var _UserDirectory2 = _interopRequireDefault(_UserDirectory);

var _Conversations = require('./components/Conversations.vue');

var _Conversations2 = _interopRequireDefault(_Conversations);

var _Chatbox = require('./components/Chatbox.vue');
...
var socket = io('http://codedevise.com:3000');
...
_vue2.default.filter('timeago', function (value, input) {
	...
	timeago = (0, _moment2.default)(timeago).fromNow();
	return timeago;
});
...
new _vue2.default({
	...
	components: { UserDirectory: _UserDirectory2.default, Conversations: _Conversations2.default, Chatbox: _Chatbox2.default },
	...
	events: {
		messageSent: function messageSent(response) {
			if (response.message) {
	...
	methods: {
		lastMessage: function lastMessage(conversation) {
			// return the last message and the name of the sender or You said...
			var lastMessageSent = conversation.messages[conversation.messages.length - 1];
			...
			return lastMessageSent.user.id === this.user.id ? 'You said ' + lastMessageSent.body.substr(0, 25) + '...' : lastMessageSent.user.name + ' said ' + lastMessageSent.body.substr(0, 25) + '...';
		},
		activateConversation: function activateConversation(conversation) {
			...
			this.$http.get('/api/v1/conversations/' + conversation.id, {
				...
				var conversation_index = this.conversations.map(function (obj, index) {
		...
		deactivateAllConversations: function deactivateAllConversations() {
			this.conversations.forEach(function (conversation) {
		...
		toggleConversations: function toggleConversations() {
			this.showConversations = !this.showConversations;
		}
	}
});

},{"./components/Chatbox.vue":31,"./components/Conversations.vue":32,"./components/UserDirectory.vue":33,"moment":1,"vue":28,"vue-resource":17}],31:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/carl/Code/messenger/resources/assets/js/components/Chatbox.vue"
...
exports.default = {
	...
	methods: {
		isActive: function isActive(conversation) {
...
},{"vue":28,"vue-hot-reload-api":3,"vueify-insert-css":29}],33:[function(require,module,exports){
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"panel panel-default\">\n\t<div class=\"panel-heading\">Members Directory</div>\n\t<table class=\"table table-striped\">\n\t\t<tbody>\n\t\t\t<tr v-for=\"member in users\" transition=\"user-row\" class=\"animated\">\n\t\t\t\t<td>\n\t\t\t\t\t<img class=\"user-avatar\" v-bind:src=\"member.avatar\" alt=\"{{ member.name }}\">\n\t\t\t\t</td>\n\t\t\t\t<td>{{ member.id }}</td>\n\t\t\t\t<td>{{ member.name }}</td>\n\t\t\t\t<td>{{ member.email }}</td>\n\t\t\t\t<td>\n\t\t\t\t\t<a @click=\"startConversation(user.id, member.id)\" data-sid=\"{{ user.id }}\" data-rid=\"{{ member.id }}\" class=\"btn btn-success btn-xs\">\n\t\t\t\t\t\tStart Conversation\n\t\t\t\t\t</a>\n\t\t\t\t</td>\n\t\t\t</tr>\n\t\t</tbody>\n\t</table>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/Users/carl/Code/messenger/resources/assets/js/components/UserDirectory.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.user-row {\n\topacity: 0;\n}\n.user-row-transition {\n\t-webkit-transition: all 0.5s ease;\n\ttransition: all 0.5s ease;\n}\n.user-row-enter {\n\topacity: 1;\n}\n.user-row-leave {\n\topacity: 0;\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
...
},{"vue":28,"vue-hot-reload-api":3,"vueify-insert-css":29}]},{},[30]);
